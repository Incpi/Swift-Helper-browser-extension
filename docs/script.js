function pc(t) {
  ...
  <div class="ui description"> When you click on the extension button, it will open a popup window that contains a
    ...
    If your page has no data of any exam, don't worry.<img class='ui rounded centered image'
      src='Snapshots/blank.webp'></img> It's because you haven't set up anything yet. Enter your
  ...
  <div class="ui description"> On the table, you can see your students' names, IDs, and attendance status. You can
    ...
    <img class='ui rounded centered image' src='Snapshots/exam_snapshot1.webp'></img>
  </div>
  ...
  <div class="ui description"> After entering the scores for each student, you need to save them by clicking on
    ...
    <img class='ui rounded centered image' src='Snapshots/markentryblue.webp'></img>
  </div>
...
function how2(t) {
  ...
  <div class="ui description">
   Extensions are small programs that add functionality to your browser. They can help you customize your browsing experience,
   enhance your productivity, or improve your security. However, not all extensions are available on the official Chrome Web Store.
   <br> Sometimes, you may want to install an extension from a zip file or a github repository. Here are the steps to do that.
  </div>
  ...
  <div class="ui description">
    ...
    <img class='ui rounded centered image' src='Github/Github_3.webp'></img>
  </div>
    ...
    <div class="ui list">
      <a class="item">
        ...
        <div class="content">
          ...
          <div class="description">Type <span class='ui blue text'> chrome://extensions </span> in the url bar and press enter.</div>
        </div>
      </a>
      <a class="item">
        <i class="right triangle icon"></i>
  ...
  <div class="ui description">
    ...
    from local files.
    <img class='ui rounded centered image' src='Github/Github_4.webp'></img>
  ...
  <div class="ui description">
    ...
    <img class='ui rounded centered image' src='Github/Github_5.webp'></img>
    <br>
    Congratulations! You have successfully installed a Chrome extension from a zip file or a github repository.
    <img class='ui rounded centered image' src='Github/Github_6.webp'></img>
    You can now use it as you would any other extension. To uninstall it, simply click on the remove button on the extension page.
  </div>
</div>`
  gujarati = `
<div class='ui segment'>
  <div class="ui header">EDGE સ્ટોર અથવા GitHub પરથી Download કરી શકો છો. </div>
  <div class="ui description">GitHub રિપોઝીટરીમાંથી Chrome Extension કેવી રીતે ઇન્સ્ટોલ કરવુ. Chrome Extension એ તમારા બ્રાઉઝરમાં કાર્યક્ષમતા ઉમેરે છે.<br>
  જો કે, અધિકૃત Chrome વેબ સ્ટોર પર તમામ એક્સ્ટેન્શન્સ ઉપલબ્ધ નથી. કેટલીકવાર, તમે GitHub રીપોઝીટરીમાંથી Extension ઇન્સ્ટોલ કરી શકવુ શકો છો. તે કરવા માટેનાં પગલાં અહીં છે.  </div>
  <div class="ui header">Step 1: Download a zip file with the extension</div>
  ...
  <div class="ui description">આ કરવા માટે 2 રીતો છે.<div class="ui list"><a class="item"><i class="right triangle icon"></i>
        <div class="content">
          <div class="header">Option 1</div>
          <div class="description">URL / Searchbar માં <span class='ui blue text'> chrome://extensions </span> લખો અને એન્ટર દબાવો. </div>
        </div>
      </a>
      <a class="item">
        <i class="right triangle icon"></i>
